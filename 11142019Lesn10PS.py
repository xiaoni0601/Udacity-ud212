...
# Python3，module json对JSON数据进行编码与解码。
# compact encoding function编码函数：json.dumps(); 
# Decoding JSON 解码函数：json.loads().
# python原始类型与json类型相互转换，eg，python-dict相互对应JSON-object